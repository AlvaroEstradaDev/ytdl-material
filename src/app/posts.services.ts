...
export class PostsService {
    ...
    createSubscription(url, name, timerange = null, maxQuality = 'best', audioOnly = false, customArgs: string = null, customFileOutput: string = null, useSubfolder = true, autoCreatePlaylist = false, audioFormat: string = null, shortsMode: 'all' | 'exclude' | 'only' = 'all', audioFormats: {short?: string; medium?: string; long?: string} = null) {
        const body: SubscribeRequest = {url: url, name: name, timerange: timerange, maxQuality: maxQuality,
            ...
            autoCreatePlaylist: autoCreatePlaylist, audioFormat: audioFormat, shortsMode: shortsMode, audioFormats: audioFormats};
