...
export class PostsService {
    ...
    createSubscription(url, name, timerange = null, maxQuality = 'best', audioOnly = false, customArgs: string = null, customFileOutput: string = null, useSubfolder = true, autoCreatePlaylist = false, audioFormat: string = null) {
        const body: SubscribeRequest = {url: url, name: name, timerange: timerange, maxQuality: maxQuality,
            ...
            autoCreatePlaylist: autoCreatePlaylist, audioFormat: audioFormat};
